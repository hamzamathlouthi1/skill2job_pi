package tn.esprit.gestionsession.services;
...
import tn.esprit.gestionsession.security.JwtTokenProvider;
...
public class AuthService {
    ...
    public JwtResponse login(LoginRequest request) {
        ...
        // Fetch full user from database to get email and ID
