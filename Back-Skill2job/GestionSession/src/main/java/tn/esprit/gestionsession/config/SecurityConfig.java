...
import tn.esprit.gestionsession.security.JwtAuthenticationFilter;
import tn.esprit.gestionsession.security.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .cors(cors -> cors.disable())  // ✅ enable CORS cleanly
