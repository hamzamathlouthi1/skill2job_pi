...
export type ViolationType = 'TAB_SWITCH' | 'COPY_PASTE' | 'FULLSCREEN_EXIT' | 'RIGHT_CLICK' | 'WINDOW_BLUR';
...
export class AntiCheatService {
  ...
  private apiUrl = 'http://localhost:8089/api/exams/violations';
  ...
  private listeners: { event: string; handler: EventListener; target: any }[] = [];
