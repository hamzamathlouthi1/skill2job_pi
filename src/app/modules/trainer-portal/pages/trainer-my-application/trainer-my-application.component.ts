...
export class TrainerMyApplicationComponent implements OnInit, OnDestroy {
  ...
  constructor(private appService: TrainerApplicationFoService) {}
      ...
      next: (data: any) => {
        ...
        if (this.lastStatus && newStatus !== this.lastStatus) {
          ...
          if (newStatus === 'ACCEPTED') {
            ...
            this.showNotification('❌ Your application has been reviewed. Unfortunately it was not accepted this time.', 'warning');
          } else {
