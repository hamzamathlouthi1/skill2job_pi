...
const routes: Routes = [
  ...
  children: [
    ...
    { path: 'exams/question-table/:examId', component: QuestionTableComponent },
    { path: 'exams/question-form', component: QuestionFormComponent },
    { path: 'exams/question-form/edit/:id', component: QuestionFormComponent },
  ...
  // User route
  {
    ...
    children: [
      ...
      { path: 'sessions', loadChildren: () => import('./modules/sessions/sessions.module').then(m => m.SessionsModule) },
