...
import { WalletService, Wallet, WalletTransaction, SpinHistory } from '../services/wallet.service';
...
export class WalletDashboardComponent implements OnInit {
  ...
  getTransactionColor(type: string): string {
    return ['CREDIT', 'WELCOME_BONUS', 'REFUND'].includes(type) ? 'positive' : 'negative';
  }
