...
export class HrService {
  ...
  approveApplication(id: number): Observable<any> {
    return this.http.put<any>(`${this.directUrl}/applications/${id}/approve`, {});
  }

  // Reject application
  rejectApplication(id: number, reason?: string): Observable<any> {
    const body = reason ? { reason } : {};
    return this.http.put<any>(`${this.directUrl}/applications/${id}/reject`, body);
  }
  ...
  createTrainerDetails(details: any): Observable<any> {
    return this.http.post<any>(`${this.baseUrl}/admin/trainer-details`, details);
  }

  // Update trainer details
  updateTrainerDetails(id: number, details: any): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/admin/trainer-details/${id}`, details);
  }
