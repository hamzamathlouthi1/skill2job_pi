...
describe('ExamService', () => {
  ...
  describe('#getExamWithQuestions', () => {
    it('should combine exam and questions', (done) => {
      ...
      const req1 = httpMock.expectOne('http://localhost:8090/api/exams/exams/1');
      req1.flush(mockExam);

      const req2 = httpMock.expectOne('http://localhost:8090/api/exams/exams/1/questions');
  ...
  describe('#submitExam', () => {
    it('should post submission and return result', () => {
      ...
      const req = httpMock.expectOne('http://localhost:8090/api/exams/exams/1/submit');
  ...
  describe('#getUserEvaluations', () => {
    it('should map evaluations and extract examId if nested', () => {
      ...
      const req = httpMock.expectOne('http://localhost:8090/api/exams/users/1/evaluations');
      req.flush(mockRaw);
    });
  });
});
